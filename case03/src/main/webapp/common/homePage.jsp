                    ...
                    <div class="card" style="background-color: #f5f4f4; border-radius: 5%">
                        ...
                        <div class="card-body p-4">
                            <h4 class="card-title">
                                ...
                                <!-- Modal -->
                                <div class="modal fade my-div" id="carDetailModal<%= count %>" tabindex="-1"
...
<%--                                                                id="username"--%>
                                                               disabled/>
<%--                                                        <label class="form-label" for="username"><%= user.getUsername() %></label>--%>
                                                    </div>
            ...
            <h4>The car was not found within the time period you search</h4>
            <% } %>
        </div>
    </div>
